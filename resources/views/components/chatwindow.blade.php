        ...
        @endphp
                ...
                <div>
                    ...
                    <script>
                        ...
                        // For mobile app, the chat is opened from navbar button
                        // For desktop, we need to initialize the open/close listeners
                        ...
                        @if(!$isMobileApp)
                            document.addEventListener('DOMContentLoaded', () => {
                                ...
                                // Function to open chat (for desktop)
                                const openChat = () => {
                                ...
                                // Function to close chat (for desktop)
                                const closeChat = () => {
