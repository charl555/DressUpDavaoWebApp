@auth
    ...
    @if(auth()->user()->role !== 'Admin' && auth()->user()->role !== 'SuperAdmin')
        ...
        <div>
            <!-- Floating Chat Button (Only show on non-mobile/desktop) -->
            @if(!$isMobileApp)
            ...
            <script>
                ...
                // Global function to toggle chat window (accessible from navbar)
                ...
                // Global function to open chat window
                ...
                // Global function to close chat window
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    // Only initialize desktop-specific event listeners if openChatBtn exists
                    if (openChatBtn) {
                        // Desktop floating button click
                        openChatBtn.addEventListener('click', () => {
                            window.openChatWindow();
                        });
                    }

                    // Close button (exists on both mobile and desktop)
                    if (closeChatBtn) {
                    ...
                    // Overlay click (exists on both mobile and desktop)
                    if (chatOverlay) {
                    ...
                    // Escape key to close (works on both)
                    document.addEventListener('keydown', (e) => {
                        if (e.key === 'Escape') {
                            const chatWindow = document.getElementById('chatWindow');
                            if (chatWindow && !chatWindow.classList.contains('translate-y-full')) {
                                window.closeChatWindow();
                            }
                        }
                    });
                ...
                window.switchToChatView = function () {
                    if (window.innerWidth <= 640) {
                        ...
                        if (contactsSection && chatSection && backToContactsBtn) {
                ...
                window.switchToContactsView = function () {
                    if (window.innerWidth <= 640) {
                        const chatSection = document.getElementById('chatSection');
                        const contactsSection = document.getElementById('contactsSection');
                        const backToContactsBtn = document.getElementById('backToContactsBtn');
                        ...
                        if (chatSection && contactsSection && backToContactsBtn) {
                            ...
                            if (activeChatName) activeChatName.textContent = 'Select a contact';
                            if (activeChatRole) activeChatRole.textContent = '';
                            if (activeChatInitial) activeChatInitial.textContent = '?';
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    if (backToContactsBtn) {
                        backToContactsBtn.addEventListener('click', window.switchToContactsView);
                    }
                    ...
                    window.addEventListener('resize', () => {
                        ...
                        if (!contactsSection || !chatSection || !backToContactsBtn) return;
                    ...
                    window.selectContact = async function (contactElement) {
                        ...
                        if (activeChatInitial) activeChatInitial.textContent = userName.charAt(0).toUpperCase();
                    ...
                    // Update navbar unread badge function
