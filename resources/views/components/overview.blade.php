            ...
            @if ($product->type === 'Gown')
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-gray-700">
                        <p><span class="font-medium">Length:</span>
                            {{ $product->product_measurements->gown_length ?? 'N/A' }} in</p>
                        <p><span class="font-medium">Upper Chest:</span>
                            {{ $product->product_measurements->gown_upper_chest ?? 'N/A' }} in</p>
                        <p><span class="font-medium">Chest:</span> {{ $product->product_measurements->gown_chest ?? 'N/A' }}
                            in</p>
                        <p><span class="font-medium">Waist:</span> {{ $product->product_measurements->gown_waist ?? 'N/A' }}
                            in</p>
                        <p><span class="font-medium">Hips:</span> {{ $product->product_measurements->gown_hips ?? 'N/A' }}
                            in</p>
                    </div>
                </div>
            @elseif ($product->type === 'Suit')
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-gray-700">
                        ...
                        <p><span class="font-medium">Bicep:</span>
                            {{ $product->product_measurements->jacket_bicep ?? 'N/A' }} in</p>
                        ...
                        <p><span class="font-medium">Thigh:</span>
                            {{ $product->product_measurements->trouser_thigh ?? 'N/A' }} in</p>
